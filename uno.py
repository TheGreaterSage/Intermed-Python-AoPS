...
class UnoCard:
    ...
    def is_match(self,other):
        ...
        return (self.color == other.color) or (self.rank == other.rank) \
               or (self.rank == 'wild') or (other.rank == 'wild') \
               or (self.rank == 'wild draw four') or (other.rank == 'wild draw four')
...
class UnoPile:
    ...
    def __init__(self,deck):
        ...
        self.top = card     # the top card in the pile
        self.wildcolor = None  # placeholder for wild card color

    def __str__(self):
        '''str(UnoPile) -> str'''
        output = 'The pile has '+str(self.top)+' on top.'
        if self.wildcolor != None:
            output += '\n'+self.wildcolor+' has been specified.'
        return output
    ...
    def add_card(self,card):
        ...
        self.top = card   # sets the card to be on top
...
class UnoPlayer:
    ...
    def play_card(self,card,pile):
        ...
        pile.add_card(card)
        # get player's choice of color for a wild card
    ...
    def take_turn(self,deck,pile):
        ...
        matches = [card for card in self.hand if card.is_match(topcard) \
                   and (card.rank != 'wild draw four' or drawFourOK)]
